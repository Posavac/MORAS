...
class Parser:
    def __init__(self, filename):
        ...
        try:
            self._read_lines() # read lines cita liniju po liniju 
        except:
        ...
        self._variables = {}
        self._init_symbols()
        self._macroLabelCnt = 0
        self._macroLabelStack = deque()
        ...
        self._parse_macros()
        if (not self._flag):
            Parser._error("MCR", self._line, self._errm)
    ...
    from parseSymbs import _parse_symbols, _parse_labels, _parse_variables, _init_symbols, _parse_macros, _expand_macro
